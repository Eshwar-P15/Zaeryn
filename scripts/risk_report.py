...
def main():
    ...
    print("=" * 80)
    print(
        f"  {'Asset':<12} {'Score':>6}  {'Label':<10}  {'Recommend':<8}  "
    ...
    for asset in ALL_ASSETS:
        ...
        print(f"  {asset:<12} {pos_pct:>7}  {pos_usd:>10}  {entry_s:>12}  {sl_s:>12}  {tp_s:>12}")
    ...
    # Alert check
    print("Alert check:\n")
    candles_map = {asset: load_candles(asset, "1h", days_back=5, conn=conn) for asset in ALL_ASSETS}
    ...
    if total_alerts == 0:
        ...
        for _asset, alerts in all_alerts.items():
            for alert in alerts:
                print(f"  {alert}")
        print()
